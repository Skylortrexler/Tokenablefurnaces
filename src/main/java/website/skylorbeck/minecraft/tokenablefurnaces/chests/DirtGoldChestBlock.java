...
public class DirtGoldChestBlock extends ExtraChestBlock {
    public DirtGoldChestBlock(Settings settings, Supplier<BlockEntityType<? extends ExtraChestEntity>> supplier) {
        super(settings, supplier);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DirtGoldChestEntity(pos, state);
    }
}