...
public class DirtNetheriteChestEntity extends ExtraChestEntity {
    protected DirtNetheriteChestEntity(BlockEntityType<?> blockEntityType, BlockPos blockPos, BlockState blockState) {
        super(blockEntityType, blockPos, blockState,6,"dirt_netherite",false,false, Ref.MODID);
    }


    public DirtNetheriteChestEntity(BlockPos pos, BlockState state) {
        super(Declarer.DIRTNETHERITECHESTENTITY,pos, state,6,"dirt_netherite",false,false, Ref.MODID);
    }
