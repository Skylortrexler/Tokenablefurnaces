...
public abstract class ExtraShulkerBlock extends BlockWithEntity {
    ...
    public ExtraShulkerBlock(@Nullable DyeColor color, AbstractBlock.Settings settings, Supplier<BlockEntityType<? extends ExtraShulkerEntity>> entityTypeSupplier) {
        super(settings);
        this.color = color;
