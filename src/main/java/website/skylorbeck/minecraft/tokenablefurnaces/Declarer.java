...
public class Declarer {
    ...
    public static Block ironFurnaceBlock = new IronExtraFurnaceBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true),0);
    ...
    public static Block ironBlastBlock = new IronExtraBlastBlock(FabricBlockSettings.copyOf(Blocks.BLAST_FURNACE).breakByHand(true));
    ...
    public static Block ironSmokerBlock = new IronExtraSmokerBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true));
    ...
    public static Block goldFurnaceBlock = new GoldExtraFurnaceBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true),0);
    ...
    public static Block goldBlastBlock = new GoldExtraBlastBlock(FabricBlockSettings.copyOf(Blocks.BLAST_FURNACE).breakByHand(true));
    ...
    public static Block goldSmokerBlock = new GoldExtraSmokerBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true));
    ...
    public static Block diamondFurnaceBlock = new DiamondExtraFurnaceBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true),0);
    ...
    public static Block diamondBlastBlock = new DiamondExtraBlastBlock(FabricBlockSettings.copyOf(Blocks.BLAST_FURNACE).breakByHand(true));
    ...
    public static Block diamondSmokerBlock = new DiamondExtraSmokerBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true));
    ...
    public static Block netheriteFurnaceBlock = new DiamondExtraFurnaceBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true).resistance(1200F),0);
    ...
    public static Block netheriteBlastBlock = new DiamondExtraBlastBlock(FabricBlockSettings.copyOf(Blocks.BLAST_FURNACE).breakByHand(true).resistance(1200F));
    ...
    public static Block netheriteSmokerBlock = new DiamondExtraSmokerBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true).resistance(1200F));
    ...
    public static Block amethystFurnaceBlock = new AmethystExtraFurnaceBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true),0);
    ...
    public static Block amethystBlastBlock = new AmethystExtraBlastBlock(FabricBlockSettings.copyOf(Blocks.BLAST_FURNACE).breakByHand(true));
    ...
    public static Block amethystSmokerBlock = new AmethystExtraSmokerBlock(FabricBlockSettings.copyOf(Blocks.FURNACE).breakByHand(true));
    ...
    public static Block ironHopperBlock = new IronHopperBlock(FabricBlockSettings.copyOf(Blocks.HOPPER).breakByHand(true));
    ...
    public static Block goldHopperBlock = new GoldHopperBlock(FabricBlockSettings.copyOf(Blocks.HOPPER).breakByHand(true));
    ...
    public static Block diamondHopperBlock = new DiamondHopperBlock(FabricBlockSettings.copyOf(Blocks.HOPPER).breakByHand(true));
    ...
    public static Block netheriteHopperBlock = new DiamondHopperBlock(FabricBlockSettings.copyOf(Blocks.HOPPER).breakByHand(true).resistance(1200F));
    ...
    public static Block amethystHopperBlock = new AmethystHopperBlock(FabricBlockSettings.copyOf(Blocks.HOPPER).breakByHand(true));
    ...
    public static Block pumpkinChestBlock = new PumpkinChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST).breakByHand(true), () -> Declarer.PUMPKINCHESTENTITY);
    ...
    public static Block ironChestBlock = new IronChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST).breakByHand(true), () -> Declarer.IRONCHESTENTITY);
    ...
    public static Block goldChestBlock = new GoldChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST).breakByHand(true), () -> Declarer.GOLDCHESTENTITY);
    ...
    public static Block diamondChestBlock = new DiamondChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST).breakByHand(true), () -> Declarer.DIAMONDCHESTENTITY);
    ...
    public static Block netheriteChestBlock = new NetheriteChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST).resistance(1200F).breakByHand(true), () -> Declarer.NETHERITECHESTENTITY);
    ...
    public static Block pumpkinTrappedChestBlock = new PumpkinTrappedChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST).breakByHand(true), () -> Declarer.PUMPKINTRAPPEDCHESTENTITY);
    ...
    public static Block ironTrappedChestBlock = new IronTrappedChestBlock(FabricBlockSettings.copyOf(Blocks.TRAPPED_CHEST).breakByHand(true), () -> Declarer.IRONTRAPPEDCHESTENTITY);
    ...
    public static Block goldTrappedChestBlock = new GoldTrappedChestBlock(FabricBlockSettings.copyOf(Blocks.TRAPPED_CHEST).breakByHand(true), () -> Declarer.GOLDTRAPPEDCHESTENTITY);
    ...
    public static Block diamondTrappedChestBlock = new DiamondTrappedChestBlock(FabricBlockSettings.copyOf(Blocks.TRAPPED_CHEST).breakByHand(true), () -> Declarer.DIAMONDTRAPPEDCHESTENTITY);
    ...
    public static Block netheriteTrappedChestBlock = new NetheriteTrappedChestBlock(FabricBlockSettings.copyOf(Blocks.TRAPPED_CHEST).resistance(1200F).breakByHand(true), () -> Declarer.NETHERITETRAPPEDCHESTENTITY);
    ...
    public static Block amethystTrappedChestBlock = new AmethystTrappedChestBlock(FabricBlockSettings.copyOf(Blocks.TRAPPED_CHEST).breakByHand(true), () -> Declarer.AMETHYSTTRAPPEDCHESTENTITY);
    ...
    public static Block ironShulkerBlock = new IronShulkerBlock(FabricBlockSettings.copyOf(Blocks.SHULKER_BOX).breakByHand(true), () -> Declarer.IRONSHULKERENTITY);
    ...
    public static Block goldShulkerBlock = new GoldShulkerBlock(FabricBlockSettings.copyOf(Blocks.SHULKER_BOX).breakByHand(true), () -> Declarer.GOLDSHULKERENTITY);
    ...
    public static Block diamondShulkerBlock = new DiamondShulkerBlock(FabricBlockSettings.copyOf(Blocks.SHULKER_BOX).breakByHand(true), () -> Declarer.DIAMONDSHULKERENTITY);
    ...
    public static Block netheriteShulkerBlock = new NetheriteShulkerBlock(FabricBlockSettings.copyOf(Blocks.SHULKER_BOX).resistance(1200F).breakByHand(true), () -> Declarer.NETHERITESHULKERENTITY);
    ...
    public static Block amethystShulkerBlock = new AmethystShulkerBlock(FabricBlockSettings.copyOf(Blocks.SHULKER_BOX).breakByHand(true), () -> Declarer.AMETHYSTSHULKERENTITY);
    ...
    public static Block ironBarrelBlock = new IronBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).breakByHand(true));
    ...
    public static Block goldBarrelBlock = new GoldBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).breakByHand(true));
    ...
    public static Block diamondBarrelBlock = new DiamondBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).breakByHand(true));
    ...
    public static Block netheriteBarrelBlock = new NetheriteBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).resistance(1200F).breakByHand(true));
    ...
    public static Block amethystBarrelBlock = new AmethystBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).breakByHand(true));
