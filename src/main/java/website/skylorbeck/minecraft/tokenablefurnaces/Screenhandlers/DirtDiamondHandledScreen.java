...
public class DirtDiamondHandledScreen extends AbstractHandledScreen {
    public static final Identifier TEXTURE = new Identifier("tokenablefurnaces", "textures/gui/dirtlarge.png");

    public DirtDiamondHandledScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
