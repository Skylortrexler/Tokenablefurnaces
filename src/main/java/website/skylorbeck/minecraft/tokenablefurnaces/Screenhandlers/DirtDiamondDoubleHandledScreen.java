...
public class DirtDiamondDoubleHandledScreen extends AbstractHandledScreen {
    public static final Identifier TEXTURE = new Identifier("tokenablefurnaces", "textures/gui/dirtlarge.png");

    public DirtDiamondDoubleHandledScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
