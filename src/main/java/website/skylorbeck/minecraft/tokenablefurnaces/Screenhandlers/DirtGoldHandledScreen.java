...
public class DirtGoldHandledScreen extends AbstractHandledScreen {
    public static final Identifier TEXTURE = new Identifier("tokenablefurnaces", "textures/gui/dirtlarge.png");

    public DirtGoldHandledScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
