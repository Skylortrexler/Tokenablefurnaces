...
public class DirtAmethystDoubleHandledScreen extends AbstractHandledScreen {
    public static final Identifier TEXTURE = new Identifier("tokenablefurnaces", "textures/gui/dirtlarge.png");

    public DirtAmethystDoubleHandledScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
