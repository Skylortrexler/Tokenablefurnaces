...
public class DirtGoldDoubleHandledScreen extends AbstractHandledScreen {
    public static final Identifier TEXTURE = new Identifier("tokenablefurnaces", "textures/gui/dirtlarge.png");

    public DirtGoldDoubleHandledScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
