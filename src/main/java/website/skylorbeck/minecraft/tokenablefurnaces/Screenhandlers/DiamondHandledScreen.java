...
public class DiamondHandledScreen extends AbstractHandledScreen {
    ...
    protected void init() {
        super.init();
        super.tabWidget = new ChestTabWidget(this, (width - backgroundWidth) / 2,(height - backgroundHeight) / 2, backgroundWidth, backgroundHeight,4);
    }
}
